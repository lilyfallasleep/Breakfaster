...
// EmployeeRepositoryImpl provides operations on employee model
...
func (repo *EmployeeRepositoryImpl) GetEmpID(lineUID string) (string, error) {
...
func (repo *EmployeeRepositoryImpl) GetLineUID(EmpID string) (string, error) {
	var employee schema.SelectIDEmployee
...
// NewEmployeeRepository is the factory for EmployeeRepositoryImpl
